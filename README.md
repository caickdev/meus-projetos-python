...
- `cadastro_multiplo.py`: Preenche formulários web automaticamente lendo dados de um CSV (nome, sobrenome, etc.).  
  Testado com sucesso: cadastrou múltiplas entradas em site de teste usando Selenium + pandas.
